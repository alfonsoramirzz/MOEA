...
class Adm extends CI_Controller {
	...
	public function altaError()
	{
		$this->load->view('adm/errorInsertar.html');
	}
...
////////////////////////////////////////////////////////////////////////////////////
	...
	public function actualizarError()
	{
		$id = $this->uri->segment(3);
		$data['convocatoria'] = $this->adm_model->obtConvocatoria($id);
		$this->load->view('adm/errorActualizar.html',$data);
	}
	...
	public function actualizarConvocatoria()
	{
		if($_POST){
			...
			{
				redirect("adm/actualizarError/".$_POST['id']);
			}
		}		
	}
}